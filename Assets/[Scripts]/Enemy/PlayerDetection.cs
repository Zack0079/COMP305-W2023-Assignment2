...
public class PlayerDetection : MonoBehaviour
{
  ...
  void Update()
  {
    if(playerDetected){
      ...
      playerDirectionVector = (playerTransform.position - transform.position);// entire vector => we onlt need a unit vector;
      playerDirectionVector.Normalize(); // create unit vector;
